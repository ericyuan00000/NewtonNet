...
class RadiusGraph(BaseTransform):
    ...
    Args:
        ...
        max_num_neighbors (int, optional): The maximum number of neighbors to
            ...
            If the number of neighbors exceeds :obj:`max_num_neighbors`, this 
            flag will be increased by a factor of :obj:`2` until it is sufficient.
    ...
    def forward(self, data: Data) -> Data:
        ...
        while True:
            ...
            if (self.max_num_neighbors > max_num_neighbors * 2) and (self.max_num_neighbors * data.pos.size(0) > num_edges * 2):
                break
            else:
